...
def main(opt):
    ...
    # Model
    model = ContinualAngularModel.auto_model(backbone_name=backbone_name, scenario=scenario, head_name=head_name).to(device)
    ...
    lfw_test_scenario = RepresentationIncremental(
        lfw_test_dataset, n_tasks=n_tasks, batch_size=batch_size, n_workers=0
    )
    ...
    calfw_test_scenario = RepresentationIncremental(
        calfw_test_dataset, n_tasks=n_tasks, batch_size=batch_size, n_workers=0
    )
    ...
    cplfw_test_scenario = RepresentationIncremental(
        cplfw_test_dataset, n_tasks=n_tasks, batch_size=batch_size, n_workers=0
    )
    ...
    agedb_30_test_scenario = RepresentationIncremental(
        agedb_30_test_dataset, n_tasks=n_tasks, batch_size=batch_size, n_workers=0
    )
